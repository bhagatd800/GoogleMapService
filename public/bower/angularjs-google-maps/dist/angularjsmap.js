...
// Places modules
angular.module('g.places.directives', []);
angular.module('g.places', [
    'g.places.directives'
])
    .run(['$window', function($window){
...
// Modules
angular.module('g.directives', []);
angular.module('g.filters', []);
angular.module('g.services', []);
angular.module('gm', [
    'g.config',
    'g.directives',
    'g.filters',
...
angular.module('g.services')
    ...
    .directive('gmPlacesAutocomplete', ['$rootScope', 'g.config', 'logger', function($rootScope, gmConfig, logger){
